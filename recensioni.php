...
<html>
    ...
    <script src="funzione_profilo_carrello.js" defer></script>
    <script src="funzione_sottomenu.js" defer></script>
    </head>
    <body>
    ...
    <header>
        <nav class="nav_sup">
            <div id="logo">
            <a href="home.php"><strong>Vinted</strong></a>
            </div>
            <div id="ricerca">
        ...
        <div class="rc">
            ...
            <form method="post" action="submit_recensione.php">
                <label>Qualità del servizio:
                <input type="range" name="qualita" min="1" max="5" required>
                </label><br>

                <label>Spedizione:
                <input type="range" name="spedizione" min="1" max="5" required>
                </label><br>

                <label>Assistenza clienti:
                <input type="range" name="assistenza" min="1" max="5" required>
                </label><br>

                <label>Commento:
                <textarea name="commento" rows="5" cols="40" required></textarea>
                </label><br>
            ...
            <div id="recensioni-container">
                ...
                $query = "SELECT username, qualita, spedizione, assistenza, commento FROM recensioni ORDER BY id DESC";
                $result = mysqli_query($conn, $query);

                while ($row = mysqli_fetch_assoc($result)) {
                    echo "<div class='recensione'>";
                    echo "<h4>Utente: " . htmlspecialchars($row['username']) . "</h4>";
                    echo "<p>Qualità: {$row['qualita']} | Spedizione: {$row['spedizione']} | Assistenza: {$row['assistenza']}</p>";
                    echo "<p>Commento: " . htmlspecialchars($row['commento']) . "</p>";
                    echo "</div>";
                }
