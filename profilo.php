...
<html>
 ...
 <head>
  ...
  <title>Profilo Vinted - <?php echo $userinfo['name']." ".$userinfo['surname'] ?></title>
...
<section class="profile-section">
  <div class="profile-header">
    ...
    <div class="profile-info">
      <h2 class="username"><?php echo $userinfo['name']." ".$userinfo['surname'] ?></h2>
      
      <p class="no-reviews"><?php echo $userinfo['username'] ?></p>
